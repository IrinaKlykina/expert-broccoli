    ...
    <form action="index.php" method="post">
            ...
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="name" class="form-control" id="input-name" placeholder="Введите имя" value="" required>
                </div>
            </div>
                <div class="row">
            ...
            <div class="row">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="age" id="age" class="form-control is-valid" placeholder="Пользователь должен быть совершеннолетним" aria-describedby="basic-addon1" required>
                </div>
             </div>
                <br>
            <div class="row">
